...
namespace Atividade_2.Models
{
    ...
    {
        private const string ConexaoPacotes = "Database=Turismo;Data Source=localhost;User Id=root";
        ...
        public void TestarConexaoPacotes()
        {
            ...
            Conexao.Open();
            Console.WriteLine("Conexão de PacotesTuristicos com o Banco de Dados realizada com sucesso!!!");
            Conexao.Close();
        }


        public List<PacotesTuristicos> ListarPcts(int Id)
        {
        ...
        public void InserirPcts(PacotesTuristicos Pacotes)
        {
        ...
        public void AterarPcts(PacotesTuristicos NovoPacote)
        {
